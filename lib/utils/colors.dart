...
class AppColors {
  static Color primary = Colors.deepOrange;
    static const Color primarycolorYellow = Color(0xfffbce84);
  ...
  static const Color welcomecolorsec = Color(0xffB0C929);
  static const Color welcomecolorthr = Color(0xff00a8b3);
  ...
  static const Color primarycolor = Color(0xff00a8b3);
  static const Color secondprimarycolor = Color.fromARGB(255, 22, 105, 213);
